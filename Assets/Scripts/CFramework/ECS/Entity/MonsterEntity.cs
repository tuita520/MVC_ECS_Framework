...
namespace Zero.ZeroEngine.ECS
{
    public class MonsterEntity : BaseEntity
    {
        ...
        //public MonsterBelongComponent monsterBelongCom;
        //public MonsterIDComponent monsterIDCom;
        ...
        //    monsterBelongCom = new MonsterBelongComponent() { baseEntity = this };
        //    monsterIDCom = new MonsterIDComponent() { baseEntity = this };
